...
function App() {
  return (
    <main className="site">
      ...
      <section className="profileSection"><div className="profileCard"><p className="eyebrow pink">PROFILE</p><h2>Haru</h2><p>花と香りをテーマに制作するキャンドルアーティスト。やさしい色づかいと、余白のあるデザインを得意とする。</p></div><div className="profileDetails"><p className="eyebrow">PROFILE</p><h2>キャンドルアーティスト Haru</h2><p>花材・色・香りを組み合わせた、やわらかな世界観のキャンドル制作を得意とするアーティスト。インテリアとして飾る美しさと、灯した時に生まれる静かな時間を大切にしています。</p><dl><div><dt>Career</dt><dd>フラワーキャンドル、ボタニカルキャンドル、ジェルキャンドルを中心に制作。</dd></div><div><dt>Lesson</dt><dd>初心者向けの少人数制レッスンを開催。作品づくりを通して、日常に小さな癒しを届けます。</dd></div><div><dt>Style</dt><dd>桜のような淡い色合い、余白のあるデザイン、贈りものに選びやすい上品な仕上がり。</dd></div></dl></div></section>
